...
use App\Http\Controllers\Web\ScienceInforController;
...
Route::get('/thong-tin-khoa-hoc', [ScienceInforController::class, 'index'])->name('scienceinfors.index');
Route::get('/thong-tin-khoa-hoc/{scienceinfor:slug}', [ScienceInforController::class, 'show'])->name('scienceinfors.show');
