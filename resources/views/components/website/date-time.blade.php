<div class="sticky top-12 z-30 bg-gray-200/60 backdrop-blur">
    <div class="items-left mx-auto flex h-10 max-w-7xl flex-row justify-between px-3 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-6 whitespace-nowrap pl-4 text-sm">
            <a class="flex items-center gap-2 text-slate-700 hover:text-blue-700" href="#">
            ...
            <a class="flex items-center gap-2 text-slate-700 hover:text-blue-700" href="{{ route('login') }}">
                <div class="rounded bg-yellow-500 p-1 text-white">
