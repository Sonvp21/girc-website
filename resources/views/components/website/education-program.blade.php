<div class="relative col-span-8 space-y-3 md:col-span-6 lg:col-span-6">
    ...
    <div class="relative">
        ...
        <div class="inset-0 flex items-end justify-center pt-3 sm:absolute sm:pt-0">
            <button
                class="transform-center lg:text-normal relative bottom-3 flex cursor-pointer items-center justify-center overflow-hidden rounded-2xl border-2 border-red-700 bg-white text-xs font-bold uppercase text-red-700 sm:bottom-[14%] md:text-sm lg:bottom-[16%] animate-scale-up-down"
                onclick="document.getElementById('modal_regiser').showModal()">
                <span class="px-4">{{ __('web.register_now') }}</span>
                <div class="bg-red-700 p-3">
                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        <path fill="#ffffff"
