<div class="sticky top-16" style="background-color: #f5f5fe">
    <div class="flex items-center gap-2 bg-blue-700 px-4 py-3 font-semibold uppercase text-white">
        <span>@lang('web.digitalconvert')</span>
    </div>
    <ul id="scroll-container-document"
        class="flex h-[350px] flex-col divide-y divide-dashed divide-blue-500 overflow-scroll overflow-y-auto overscroll-contain border border-blue-500 text-sm scrollbar-hide">
