...
>
    ...
    >
        <ul class="text-normal flex w-full flex-col text-xs lg:flex-row lg:divide-x-0 lg:divide-y-0">
            ...
            <li
                class="relative flex-row whitespace-nowrap"
            ...
            >
                ...
                <div
                    class="hidden w-full origin-top-left bg-white shadow-md md:w-auto lg:absolute"
                ...
                >
                    <ul class="text-denim-600 divide-denim-400 w-full origin-top-left divide-y divide-dashed whitespace-nowrap bg-white">
                        <li class="hover:bg-black hover:bg-opacity-5">
                            <a
                                class="flex items-center justify-start space-x-2 px-2 py-4 text-slate-800"
                                href=""
                            >
            ...
            >
                ...
                >
                    <button
                        ...
                        @mouseover="dropdownOpen = true"
                    >
                        <span class="flex w-full justify-between gap-2 border-white px-2 lg:w-auto lg:justify-start"> Quỹ phát triển tài năng </span>
                    </button>
                </div>
            </li>
        </ul>
