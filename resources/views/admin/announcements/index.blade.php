<x-app-layout>
    <x-slot name="header">
        ...
        <div>
            <a class="flex items-center justify-end" href="{{ route('admin.announcements.create') }}"><x-heroicon-o-plus-circle
                    ...
                    <table class="table">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>@lang('admin.announcement.created_at')</th> {{-- ngày đăng --}}
                                <th>@lang('admin.announcement.updated_at')</th> {{-- ngày cập nhật --}}
