            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="bg-white p-4 shadow sm:rounded-lg sm:p-8">
                    <div class="max-w-2xl" style="margin-left: 30%">
                        <form action="{{ route('admin.contacts.update', ['contact' => $contact->id]) }}" method="POST" class="needs-validation"
                            novalidate>
                            @csrf
                            @method('patch')
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text" name="name" value="{{ old('name', $contact->name) }}" placeholder="Put name"
                                    @class([
                                        'input',
                                        'input-bordered',
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text" name="phone" value="{{ old('phone', $contact->phone) }}" placeholder="0987...."
                                    @class([
                                        'input',
                                        'input-bordered',
