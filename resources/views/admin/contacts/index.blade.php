<x-app-layout>
    <x-slot name="header">
        ...
        <div>
            <a class="flex items-center justify-end" href="{{ route('admin.contacts.create') }}"><x-heroicon-o-plus-circle
                    class="size-4" />
                @lang('admin.add')
            </a>
        </div>
                    ...
                    <table class="table">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>@lang('admin.contacts.read_at')</th> {{-- ngày xem --}}
                                <th>@lang('admin.contacts.created_at')</th> {{-- ngày gửi --}}
