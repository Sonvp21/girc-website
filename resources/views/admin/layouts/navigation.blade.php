<nav x-data="{ open: false }" class="border-gray-100 border-b bg-white">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="dropdown dropdown-hover self-center">
                        ...
                        <ul tabindex="0" class="menu dropdown-content z-[1] w-52 rounded-box bg-base-100 p-2 shadow">
                            ...
                            <li>
                                <x-nav-link :href="route('admin.photos.index')" :active="request()->routeIs('admin.photos.index')">
                            ...
                            <li>
                                <x-nav-link :href="route('admin.cooperations.index')" :active="request()->routeIs('admin.cooperations.index')">
