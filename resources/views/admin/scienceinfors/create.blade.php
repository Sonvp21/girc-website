        ...
        <div class="mt-6">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="bg-white px-8 pb-8 pt-0 shadow sm:rounded-lg">
                    <form action="{{ route('admin.scienceinfors.store') }}" method="POST"
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="title_en" value="{{ old('title_en') }}" placeholder="Title english(if have)"
                                    @class([
                                        'input',
                                        'input-bordered',
                        ...
                        <div class="flex justify-end gap-4">
                            <a href="{{ route('admin.scienceinfors.index') }}" class="btn-light btn">@lang('admin.btn.cancel')
                            </a>
