                    ...
                    <form action="{{ route('admin.science-information.update', $scienceInformation) }}" method="POST" class="needs-validation space-y-4" novalidate enctype="multipart/form-data">
                        ...
                        <div class="flex gap-4">
                            <label class="form-control">
                                <div class="label">
                                    <span class="label-text">@lang('admin.science-information.published_at')</span>
                                </div>
                        ...
                        <div class="flex gap-4">
                            <label class="form-control w-full">
                                <div class="label">
                                    <span class="label-text">@lang('admin.science-information.title')</span>
                                </div>
                            ...
                            <label class="form-control w-full">
                                <div class="label">
                                    <span class="label-text">@lang('admin.science-information.title_en')</span>
                                </div>
                        ...
                        <label class="form-control w-full">
                            <div class="label">
                                <span class="label-text">@lang('admin.science-information.keep_on_top')</span>
                            </div>
